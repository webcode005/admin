...
define ("page_name", "Add Testimonial");
...
// $ins->execute();
$insert = $conn->prepare("INSERT INTO testimonial SET name=?, image=?,message=?");
...
<div class="row">
	...
	<div class="col-9">
		<div class="form-group">
			<textarea class="form-control" name="message" id="" placeholder="Place some text here" required></textarea>
		</div>
	</div>
</div>
