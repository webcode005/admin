...
|| ($_FILES['main_image']['type'] == "application/pdf")
|| ($_FILES['main_image']['type'] == "application/msword")
...
// $ins->execute();
$insert = $conn->prepare("UPDATE catalog SET name=?, image=? WHERE id='".$id."'");
...
$insert->execute();
 ...
 echo "<script> setTimeout(function () { window.location.href = 'edit-catalog.php?cid=$id'; }, 1000); </script>";
//}
}
?>
...
<div class="row">
	<div class="col-3">
		<div class="form-group">
			<label for="product_name"> File Upload</label>
		</div>
	</div>
	<div class="col-6">
		<div class="form-group">
		    	<input type="hidden" class="form-control" name="hidden_main_image" value="<?php echo $row['image'];?>">
