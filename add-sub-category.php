<?php 
	...
	if(isset($_POST['submit'])){
	   ...
	   //url end ===========================================================
	    $insert = $conn->prepare("INSERT INTO sub_category SET category_id=?, sub_category_name=?,url_key=?");
										...
										<form role="form" method="POST" enctype="multipart/form-data">
											<div class="card-body">
												...
												<div class="row">
													...
													<div class="col-6">
														<div class="form-group">
															<input type="text" class="form-control" id="" name="sub_category_name" placeholder="Enter Category Name">
														</div>
													</div>
												</div>
