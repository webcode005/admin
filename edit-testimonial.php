...
define ("page_name", "Edit Testimonial");
$id = $_GET['cid'];
$select = $conn->query("SELECT * FROM testimonial WHERE id='".$id."'");
...
// $ins->execute();
$insert = $conn->prepare("UPDATE testimonial SET name=?, image=?,message=? WHERE id='".$id."'");
$insert->bind_param("sss",$title,$custome_p_image,$description);
...
<div class="row">
	...
	<div class="col-6">
		<div class="form-group">
			<input type="text" class="form-control" id="title" name="name" value="<?php echo $data['name'];?>" placeholder="Enter Title" required>
		</div>
	</div>
</div>
</div>
...
<div class="row">
	<div class="col-3">
		<div class="form-group">
			<label for="product_name"> Profile Image</label>
		</div>
	</div>
	<div class="col-6">
		<div class="form-group">
		    <input type="hidden" class="form-control" id="" value="<?php echo $data['image'];?>" name="hidden_main_image" placeholder="Enter Title" required>
...
<div class="row">
	...
	<div class="col-6">
		<div class="form-group">
			<textarea class="form-control" name="message" id="" placeholder="Place some text here" required><?php echo $data['message'];?></textarea>
		</div>
	</div>
</div>
